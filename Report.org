...
The net reproduction number is estimated to be around or below 1 and the peak in admissions and deaths forecast from mid-April, and the peak in resource use being forecast around the mid-April to start-May. 
