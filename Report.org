...
For the first time the net reproduction number is estimated to be around 1 and the peak in admissions and deaths forecast during the next week, and the peak in resource use being forecast around the start of May. Some of this may be due to the anomalously low new case count for today.

** Recent changes

<2020-04-07 Tue>

- _Infectious period changed_ from 4.6 to 2.9 days, following Kucharski et al [[https://doi.org/10.1016/S1473-3099(20)30144-4]]. This leads to somewhat lower initial $R_0$ estimates (nearer 3 than 4), and lower peaks.
...
- In output PrevData.csv, "hosp" variable has been renamed "admissions"
...
percecnt; with 3.8% of cases confirmed it is: 
