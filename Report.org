...
The net reproduction number is estimated to be around or below 1 and the peak in admissions and deaths forecast from mid-April to start-May, and the peak in resource use being forecast around the start of May. Some of this may be due to the anomalously low new case count for today.
